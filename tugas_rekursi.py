...
# Fungsi method len adalah Mengembalikan panjang objek
# Fungsi method iter adalah Mengembalikan iterator objek
# Fungsi method get adalah Mengembalikan nilai dari atribut objek
# Fungsi method pop adalah menghapus dan mengembalikan item terakhir dari dalam list
